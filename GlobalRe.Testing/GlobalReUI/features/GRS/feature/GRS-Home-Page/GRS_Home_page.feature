Feature: GRS Home Page Feature
  ...
  #Precondition is ERMS application should be launched atleast once per day
  @regression
  ...
  #DB Query needs to update - all the data need ot enabled
...
#      | On Hold                 | NPTA            |
#      | Bound - Pending Actions | NPTA            |
#      | In Progress             | Actuary         | enable from here to donw
#      | Renewable - 6 Months    | Actuary         |
#      | On Hold                 | Actuary         |
#      | Bound - Pending Actions | Actuary         |
#      | In Progress             | PTA             |
...
#    And I will be able to see tool menu popup
  ...
  Scenario Outline: Verify the Remove Columns functionality within the grid using Tool Panel
    Given I open the browser and navigate to GRS link and click on the <status> Panel
    And I click on the Tool menu Link in the column heading
#    And I will be able to see tool menu popup
    And I click to select the Tool Panel option
    And I will be able to see Tool Panel displayed on the right side of the grid
    And I click to uncheck the checkbox of the <columnname> column not to be displayed in the grid Using Tool Panel
    Then I will be able to see the grid not displaying the <columnname> column in the grid
    Examples:
      | status                  |columnname       |
      | In Progress             |Deal Name*Contract #*Inception*Target Date*Submitted        |
      #| Renewable - 6 Months    |Contract         |
      #| On Hold                 |Contract         |
      #| Bound - Pending Actions |Contract         |
