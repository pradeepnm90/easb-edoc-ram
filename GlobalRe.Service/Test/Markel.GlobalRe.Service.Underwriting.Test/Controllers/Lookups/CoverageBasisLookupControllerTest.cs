...
namespace Markel.GlobalReUnderwriting.Service.Test.Lookups.Controllers
{
	...
	class CoverageBasisLookupTest
	{
		...
		[Test]
		public void CoverageBasisLookupController_Get_StatusOK()
		{

			#region Arrange

			var mockRepository = new Mock<ICoverageBasisLookupRepository>();
			CoverageBasisLookupManager lookupManager = new CoverageBasisLookupManager(userManager.Object, cacheStoreManager.Object, mockRepository.Object);

			#endregion

			#region Act
			CoverageBasisLookupController controller = new CoverageBasisLookupController(userManager.Object, lookupManager);
			#endregion
