...
{
    public class WorkbenchDealsRepository : GenericRepository<ERMSDbContext, grs_VGrsDealsByStatu, int>, IWorkbenchDealsRepository
    {
        #region Constants
        ...
        #region Constructor
        public WorkbenchDealsRepository(IUserManager userManager, IAmbientDbContextLocator ambientDbContextLocator) : base(userManager, ambientDbContextLocator) { }
        ...
        private Expression<Func<grs_VGrsDealsByStatu, bool>> FilterStatusCodes(IEnumerable<FilterParameter> parameters)
        {
            //TODO-PS : Refactor
        ...
        private Expression<Func<grs_VGrsDealsByStatu, bool>> FilterExposuretypes(IEnumerable<FilterParameter> parameters)
        {
            string exposuretypes = parameters.FirstOrDefaultValue<string>(FilterParameters.Exposuretypes);
        ...
        private Expression<Func<grs_VGrsDealsByStatu, bool>> FilterPopulatedExposuretypes(IEnumerable<FilterParameter> parameters)
        {
            string exposuretypes = parameters.FirstOrDefaultValue<string>(FilterParameters.PopulatedExposuretypes);
            if (!string.IsNullOrEmpty(exposuretypes))
            {
                if (exposuretypes.Contains(COMMA_SEPARATOR))
                {
        ...
        private Expression<Func<grs_VGrsDealsByStatu, bool>> FilterBasedOnPersonIds(IEnumerable<FilterParameter> parameters)
        {

            Expression<Func<grs_VGrsDealsByStatu, bool>> personExpression = null;
            string personids = parameters.FirstOrDefaultValue<string>(FilterParameters.PersonIds);
